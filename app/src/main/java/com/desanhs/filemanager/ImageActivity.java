...
import com.desanhs.filemanager.storage.Image;
import com.desanhs.filemanager.storage.ImageData;
import com.desanhs.filemanager.storage.ImagesAdapter;
...
public class ImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getPermissions()){
            ArrayList<Image> images = ImageData.getImages(this);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.images), ((v, insets) -> {
                        ...
                        public void onActivityResult(ActivityResult o) {
                            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R){
                                ...
                                if(Environment.isExternalStorageManager()){
                                    ...
                                    Toast.makeText(ImageActivity.this, "Storage Permissions Denied", Toast.LENGTH_SHORT).show();
                                }
                            }else{
                                //Below android 11
